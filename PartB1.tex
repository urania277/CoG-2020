...
%Tim's comment: probably OK in the abstract, but make sure you convince the reader in the main proposal that it is really compelling
...
%The PEB technique writes out only a subset of the ATLAS detector data, with an extreme in TLA where only physics objects recorded at the  
